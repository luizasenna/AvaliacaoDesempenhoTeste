...
class FrontEndController extends JoshController
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        // Redirect to the user page
        return Redirect::route('index')->withInput()->with('error', $error);
    ...
    public function getActivate($userId, $activationCode)
    {
        ...
        if (Activation::complete($user, $activationCode)) {
            ...
            return Redirect::route('login')->with('successo', 'Você entrou com sucesso no RH Intranet');
        } else {
    ...
    public function postForgotPassword(Request $request)
    {
        try {
            ...
            Mail::send('emails.forgot-password', $data, function ($m) use ($user) {
                $m->to($user->email, $user->first_name . ' ' . $user->last_name);
                $m->subject('Recuperação de Senha do RH Intranet');
            });
        } catch (UserNotFoundException $e) {
    ...
    public function getLogout()
    {
        ...
        return Redirect::to('login')->with('successo', 'Você saiu da sua conta. Aguardamos seu retorno em breve.');
    }
