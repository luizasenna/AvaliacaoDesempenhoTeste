...
<body style="">
    ...
    <section class="content-header">
            ...
            <table class="table" width="100%">
                <tr class="col-md-12">
                    <td class="col-md-5" style="border: none;"><h4>Logo</h4></td>
                    <td class="col-md-7 pull-right" style="border: none;"><h4><center>DEPARTAMENTO DE RECURSOS HUMANOS</center></h4></td>
		...
		<div class="col-md-12">
            <div class="panel panel-info">
						<div class="panel-body"  style="padding-bottom:0;">
							<!-- Foto -->
							<div class="col-md-2" style="width:15%;float:left;margin-left:100px;;margin-bottom:0;">
							...
							<div class="col-md-6 pull-right" style="width:63%;margin-right:58px;">
    ...
    <!--Adicionado Notas-->
    <div class="col-md-12">
                <div class="panel panel-info" style="padding:0;margin-bottom:0;margin-top:0;">
                    <!--<div class="panel-heading">
