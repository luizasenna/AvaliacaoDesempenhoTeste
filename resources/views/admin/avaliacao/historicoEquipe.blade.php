                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                ...
                                Histórico de Mudança de Equipes de Avaliações
                            </h3>
										...
										<table class="table table-striped">
											...
											<tr>
												...
												<td>{{$h->avaliado? $h->avaliado->NOME: '---'}}</td>
											     <td>{{$h->avaliado? $h->avaliado->CHAPA: '---'}}</td>
												<td>{{$h->antigaequipe? str_limit($h->antigaequipe->DESCRICAO, 20): '---'}}</td>
												<td>{{$h->novaequipe? str_limit($h->novaequipe->DESCRICAO, 20): '---'}}</td>
