                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="commentForm" action="{{ route('admin.users.store') }}"
                            ...
                            <div id="rootwizard">
                                <ul>
                                    <li><a href="#tab1" data-toggle="tab">Informações do Usuário</a></li>
                                    ...
                                    <li><a href="#tab5" data-toggle="tab">Informações TOTVS</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane" id="tab1">
                                        ...
                                        <div class="form-group">
                                            <label for="last_name" class="col-sm-2 control-label">Último  Nome *</label>
                                            <div class="col-sm-10">
                                                <input id="last_name" name="last_name" type="text" placeholder="Sobrenome"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="password_confirm" name="password_confirm" type="password"
                                                       placeholder="Confirme a Senha " class="form-control required"
                                    ...
                                    <div class="tab-pane" id="tab2" disabled="disabled">
                                        <h2 class="hidden">&nbsp;</h2> <div class="form-group ">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="dob" name="dob" type="text" class="form-control"
                                                       data-mask="99-99-9999" value="{!! old('dob') !!}"
                                        ...
                                        <div class="form-group">
                                            <label for="pic" class="col-sm-2 control-label">Foto do Perfil</label>
                                            <div class="col-sm-10">
                                ...
                                <span class="btn btn-default btn-file">
                                    ...
                                    <input id="pic" name="pic_file" type="file" class="form-control"/>
                                                        ...
                                                        <a href="#" class="btn btn-danger fileinput-exists"
                                                           data-dismiss="fileinput">Apagar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <textarea name="bio" id="bio" class="form-control"
                                  rows="4">{!! old('bio') !!}</textarea>
                                        ...
                                        <div class="form-group {{ $errors->first('gender', 'has-error') }}">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" title="Select Gender..." name="gender">
                                                    ...
                                                    <option value="other"
                                                            @if(old('gender') === 'other') selected="selected" @endif >Outro
                                                    </option>
                                    ...
                                    <div class="tab-pane" id="tab4" disabled="disabled">
                                        <p class="text-danger"><strong>Atenção aí na seleção do grupo para não dar acessos a mais para o usuário</strong></p>

                                        <div class="form-group required">
                                            <label for="group" class="col-sm-2 control-label">Grupó *</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span>Se você não marcar como ativo, será enviado um link no email cadastrado para ativação</span></div>
                                        </div>
                                    </div>
                                     <div class="tab-content">
                                    <div class="tab-pane" id="tab5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="filial" name="filial" type="text"
                                                       placeholder="Filial" class="form-control"
                                                       value="{!! old('filial') !!}"/>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="chapa" class="col-sm-2 control-label">Chapa </label>
                                            <div class="col-sm-10">
                                                <input id="chapa" name="chapa" type="text" placeholder="Chapa"
                                                       class="form-control" value="{!! old('chapa') !!}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="codequipe" name="codequipe" placeholder="Código da Equipe" type="text"
                                                       class="form-control email" value="{!! old('equipe') !!}"/>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="codsecao" class="col-sm-2 control-label">Seção </label>
                                            <div class="col-sm-10">
                                                <input id="codsecao" name="codsecao" type="text" placeholder="Código da Seção"
                                                       class="form-control" value="{!! old('codsecao') !!}"/>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="codfuncao" class="col-sm-2 control-label">Código da Função </label>
                                            <div class="col-sm-10">
                                                <input id="codfuncao" name="codfuncao" type="text"
                                                       placeholder="Código da Função " class="form-control"
                                                       value="{!! old('codfuncao') !!}"/>
                                            </div>
                                        </div>
                                    </div>
